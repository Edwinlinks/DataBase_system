    ...
    <el-dialog title="提示" v-model="dialogVisible" width="30%">
      <el-form :model="form" label-width="120px">
        <el-form-item label="账号">
          <el-input v-model="form.username" style="width: 80%" placeholder="必填"></el-input>
        </el-form-item>
        <el-form-item label="密码">
          <el-input v-model="form.password" style="width: 80%" placeholder="必填"></el-input>
        </el-form-item>
        <el-form-item label="姓名">
          <el-input v-model="form.name" style="width: 80%" placeholder="必填"></el-input>
        </el-form-item>
        <el-form-item label="电话">
          <el-input v-model="form.phone" style="width: 80%" placeholder="必填"></el-input>
        </el-form-item>
        <el-form-item label="邮箱">
          <el-input v-model="form.email" style="width: 80%" placeholder="必填"></el-input>
        </el-form-item>
        <el-form-item label="学号">
          <el-input v-model="form.stuId" style="width: 80%" placeholder="必填"></el-input>
        </el-form-item>
        <el-form-item label="工作室">
          <el-input v-model="form.studioName" style="width: 80%" placeholder="必填"></el-input>
        </el-form-item>
      </el-form>
      <template #footer>
